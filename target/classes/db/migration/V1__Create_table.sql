...
alter table albums add constraint aa1 foreign key (usrid) references usr(id);
alter table albums add constraint aa2 foreign key (albumid) references album(id);
alter table photos add constraint a1 foreign key(albumid) references album(id);
alter table photos add constraint a2 foreign key (photoid) references photo(id);