...
alter table comment_like
    add constraint ccml1 foreign key (comment_id) references comment (id);
alter table comment_like
    add constraint ccml2 foreign key (user_id) references usr (id);

alter table usermessage_likes
    add constraint usml1 foreign key (usermessage_id) references usrmessage (id);
alter table usermessage_likes
    add constraint usml2 foreign key (user_id) references usr (id);

alter table commessage_likes
    add constraint cml1 foreign key (commessage_id) references commessage (id);
alter table commessage_likes
    add constraint cml2 foreign key (user_id) references usr (id);
